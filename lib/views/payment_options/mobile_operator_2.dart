...
class MobileOperator2 extends StatefulWidget {
  MobileOperator2(this.amount,this.pm,this.pmt,{Key? key}) : super(key: key);
  String amount;
  String pm;
  String pmt;
  @override
  MobileOperator2State createState() => MobileOperator2State();
}

class MobileOperator2State extends State<MobileOperator2> {
  String email ='';
  String uid ='';
