...
Future<List<TopicsData>> fetchTopics(String tag, String subj,int package) async {
  final response = await http.get(Uri.parse(
      'https://educanug.com/educan_new/educan/api/library/get_topics.php?class=$tag&subject=$subj&pack=$package'));
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          FutureBuilder<List<TopicsData>>(
              future: fetchTopics(widget.subid.toString(), widget.catid,widget.package),
